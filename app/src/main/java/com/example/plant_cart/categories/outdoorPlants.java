...
public class outdoorPlants extends AppCompatActivity {
    private RecyclerView outdoorlist;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        outdoorlist = findViewById(R.id.outdoorlist);
        searchView = findViewById(R.id.search_badgeod);
        ...
        //Query
        Query query = firebaseFirestore.collection("Outdoor Plants");
        ...
        adapter = new FirestoreRecyclerAdapter<plantsModel, outdoorPlants.plantsViewHolder>(options) {
            @NonNull
            @Override
            public outdoorPlants.plantsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.cardview,parent, false);
                return new outdoorPlants.plantsViewHolder(view);
            }

            @Override
            protected void onBindViewHolder(@NonNull outdoorPlants.plantsViewHolder holder, int position, @NonNull final plantsModel model) {
        ...
        //View Holder
        //outdoorlist.setHasFixedSize(true);
        outdoorlist.setLayoutManager(new LinearLayoutManager(outdoorPlants.this));
        outdoorlist.setAdapter(adapter);
